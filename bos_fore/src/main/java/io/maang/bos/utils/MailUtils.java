...
public class MailUtils {
	...
	private static String userName = "82566@163.com";//发 送 邮 件的1 6 3邮 箱 账 号
    private static String password = "ming175";//1 6 3 邮 箱 的 授 权 码，若 没 有 则 使 用 密 码
